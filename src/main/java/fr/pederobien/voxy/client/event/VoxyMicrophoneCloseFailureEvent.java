...
public class VoxyMicrophoneCloseFailureEvent extends Event {
	private final Exception exception;

	/**
	 * Creates an event thrown when an error occurred while closing the microphone.
	 * 
	 * @param exception The exception thrown by the microphone.
	 */
	public VoxyMicrophoneCloseFailureEvent(Exception exception) {

...
public class VoxyRoomRemoveFailureEvent extends Event {
	private final String roomName;

	/**
	 * Creates an event thrown when the server denied to remove a room.
	 * 
	 * @param roomName The name of the room to remove.
	 */
	public VoxyRoomRemoveFailureEvent(String roomName) {

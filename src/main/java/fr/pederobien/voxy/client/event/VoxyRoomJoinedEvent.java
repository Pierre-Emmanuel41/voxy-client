...
public class VoxyRoomJoinedEvent extends VoxyRoomEvent {
	private final IVoxyPlayer player;

	/**
	 * Creates an event thrown when a player joined a voxy room.
	 * 
	 * @param room   The room that a player joined.
	 * @param player The player that joined a room.
	 */
	public VoxyRoomJoinedEvent(IVoxyRoom room, IVoxyPlayer player) {
		super(room);
